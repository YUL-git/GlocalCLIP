...
class ResidualAttentionBlock_learnable_token(nn.Module):
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None, design_details=None,
        ...
        self.i = i
        self.compound_prompt_nctx = design_details['Deep_Text_Prompt_Length']
        self.nctx = design_details['Normal_Prompt_Length']
        self.abnctx = design_details['Anomaly_Prompt_Length']
